              ...
              {CONTACT_INFO.map((item) => {
                ...
                const card = (
                  ...
                  >
                    ...
                    {item.href && (
                      <ExternalLink className="w-3.5 h-3.5 text-blue-500 opacity-60" />
                    )}
                  </motion.div>
                );
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-sm font-medium">
                        Message prepared! Opening your mail app to send directly to Yash.
                      </p>
                    </div>
                  </motion.div>
                )}
                ...
                {submitStatus === "error" && (
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-sm font-medium">
                        Unable to open email client. Please email directly at yashchau.work@gmail.com
                      </p>
                    </div>
                  </motion.div>
                )}

...
export function MenuBar({
  ...
  const appleMenuItems: MenuItem[] = [
    ...
    { label: "Log Out Yash...", shortcut: "⇧⌘Q", action: () => {} },
  ];
        ...
        <div className="flex items-center gap-1">
          ...
          <div className="relative flex items-center">
            <button
              ...
              className={`p-1 rounded flex items-center gap-1.5 transition-colors ${
                activeMenu === "apple"
                  ? isDark
                    ? "bg-white/20"
                    : "bg-black/10"
            ...
            >
              <div className="w-5 h-5 rounded-md bg-gradient-to-tr from-blue-600 to-purple-600 text-white font-bold text-[10px] flex items-center justify-center shadow-sm">
                YC
              </div>
            </button>

...
const TerminalApp = lazy(() =>
  import("@/components/apps/Terminal").then((module) => ({ default: module.Terminal })),
);
const FinderApp = lazy(() =>
  import("@/components/apps/Finder").then((module) => ({ default: module.Finder })),
);
const AboutApp = lazy(() =>
  import("@/components/apps/About").then((module) => ({ default: module.About })),
);
const ProjectsApp = lazy(() => import("@/components/apps/Projects"));
const SkillsApp = lazy(() => import("@/components/apps/Skills"));
const ExperienceApp = lazy(() => import("@/components/apps/Experience"));
const ContactApp = lazy(() =>
  import("@/components/apps/Contact").then((module) => ({ default: module.Contact })),
);
const ResumeApp = lazy(() =>
  import("@/components/apps/Resume").then((module) => ({ default: module.Resume })),
);
const SettingsApp = lazy(() =>
  import("@/components/apps/Settings").then((module) => ({ default: module.Settings })),
);
const SpotifyApp = lazy(() => import("@/components/apps/Spotify"));
const JournalApp = lazy(() => import("@/components/apps/Journal"));
const GalleryApp = lazy(() =>
  import("@/components/apps/Gallery").then((module) => ({ default: module.Gallery })),
);
const CameraApp = lazy(() => import("@/components/apps/Camera"));
const YoutubeApp = lazy(() => import("@/components/apps/Youtube"));
...
function App() {
  ...
  const renderAppContent = useCallback(
    (appId: string) => {
      switch (appId) {
        case "terminal":
          return <TerminalApp isDark={isDark} />;
        case "finder":
          return <FinderApp isDark={isDark} />;
        case "about":
          return <AboutApp isDark={isDark} />;
        case "gallery":
          return <GalleryApp isDark={isDark} />;
        case "projects":
          return <ProjectsApp />;
        case "skills":
          return <SkillsApp />;
        ...
        case "contact":
          return <ContactApp isDark={isDark} />;
        case "resume":
          return <ResumeApp isDark={isDark} />;
        case "settings":
          return (
            <SettingsApp
              isDark={isDark}
        ...
        case "spotify":
          return <SpotifyApp isDark={isDark} />;
        case "youtube":
          return <YoutubeApp isDark={isDark} />;
        case "journal":
          return <JournalApp isDark={isDark} />;
        case "camera":
          return <CameraApp isDark={isDark} />;
        default:
          return (
    ...
    <AnimatePresence>
      {!isComplete && (
        <motion.div
          ...
          className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-[radial-gradient(circle_at_top,rgba(56,189,248,0.12),transparent_36%),linear-gradient(180deg,#04050a_0%,#070b14_100%)]"
        >
          {/* Apple Logo with Soft Glow */}
          <motion.div
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            transition={{ duration: 0.6, ease: "easeOut" }}
            className="mb-10 drop-shadow-[0_12px_30px_rgba(255,255,255,0.18)]"
          >
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
          ...
          <div className="h-1 w-56 overflow-hidden rounded-full bg-white/10">
            <motion.div
              ...
              className="h-full rounded-full bg-gradient-to-r from-cyan-300 via-white to-amber-300"
            />
          </div>
        </motion.div>
      )}
